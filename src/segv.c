...
static mrb_value mrb_segv_init(mrb_state *mrb, mrb_value self)
{
    ...
    mrb_value str2 = mrb_str_new_cstr(mrb, code);
    ...
    mrb_value fiber3 = mrb_funcall_with_block(mrb, fiber_class1, new, 0, NULL, mrb_obj_value(mrb_closure_new(mrb, proc1->body.irep)));
    p(mrb, mrb_fiber_resume(mrb, fiber3, 0, NULL));
}
